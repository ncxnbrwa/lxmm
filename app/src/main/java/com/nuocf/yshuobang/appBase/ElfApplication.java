...
public class ElfApplication extends Application{
    ...
    private static ElfApplication mAppInstance;
	// 用于存放倒计时时间
	...
	//饿汉单例
    public static ElfApplication getInstance(){
    	return mAppInstance;
    }
    
	public ElfApplication() {
